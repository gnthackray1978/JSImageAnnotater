...
function loadAll (drive){
    ...
    data.init(function(){
        ...
        var rectangleSelector = new RectangleSelect(nodeManager,options);
        var rectangleSelectorController = new RectangleSelectController(appView,channel,rectangleSelector,nodeManager);
